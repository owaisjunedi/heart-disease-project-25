...
This service uses a **Random Forest Classifier** trained on the classic [UCI Cleveland Heart Disease dataset](https.link.to.dataset/...). The model analyzes 13 clinical features (such as age, cholesterol, chest pain type, and EKG results) to generate a binary prediction of whether a patient has heart disease.
